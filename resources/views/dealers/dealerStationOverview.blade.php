...
@section('content')
    ...
    <h2 class="main-title">Stations for: {{ $dealer->first_name }} {{ $dealer->middle_name }} {{ $dealer->last_name }}</h2>
        ...
        <div class="col-lg-12">
            ...
            <div class="detail-table w-full">
                ...
                <div class="filt">
                    ...
                    <div>
                        <form method="GET" action="{{ route('dealerStationOverview', $dealer->id) }}">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (ctx) {
                ...
                fetch("{{ route('getDealerStationStats', $dealer->id) }}")
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (dealerAverageChart) {
                ...
                fetch("{{ route('getDealerStationAverage', $dealer->id) }}")
                .then(response => response.json())
                .then(data => {
