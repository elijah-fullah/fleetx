...
@section('content')
    ...
    <h2 class="main-title">Dealers for: {{ $station->stationName }}</h2>

    <div class="back-button">
        <a href="{{ route('viewStationProfile', $station->id) }}" 
           class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
           <i class="fa-solid fa-arrow-left"></i> Back to {{ $station->stationName }} Profile
        </a>
    </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="detail-table w-full">
                ...
                <div class="filt">
                    ...
                    <div>
                        <form method="GET" action="{{ route('dealerStationOverview', $station->id) }}">
                ...
                <div class="detail-footer">
                    <div class="pagination-info">
                        Showing {{ $dealers->firstItem() }} to {{ $dealers->lastItem() }} of {{ $dealers->total() }} results
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (ctx) {
                ...
                fetch("{{ route('getStationDealerStats', $station->id) }}")
        ...
        document.addEventListener('DOMContentLoaded', function () {
            var stationAverageChart = document.getElementById('stationAverageChart');
    
            if (stationAverageChart) {
                var customersChartCanvas1 = stationAverageChart.getContext('2d');
        
                fetch("{{ route('getStationDealerAverage', $station->id) }}")
                .then(response => response.json())
                .then(data => {
