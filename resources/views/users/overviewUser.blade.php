...
@section('content')
    ...
    <h2 class="main-title">Users Overview</h2>        
        ...
        <div class="col-lg-12">
            ...
            <div class="detail-table w-full">
                ...
                <div class="filt">
                    ...
                    <div>
                        <form method="GET" action="{{ route('overviewUser') }}">
                        ...
                        @foreach ($allUser as $user)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    <span class="{{ $statusClass }}">{{ ucfirst($user->status) }}</span>
                                </td>
                                <td>
                                    ...
                                    <ul class="users-item-dropdown dropdown">
                                        <li><a href="{{ route('editUser', $user->id ?? 0) }}">Edit</a></li>
                                        <li><a href="{{ route('viewUserProfile', $user->id ?? 0) }}">View Profile</a></li>
                                        <li>
                                            <a href="#" onclick="openSuspendModal('{{ route('suspendUser', $user->id) }}', '{{ $user->status }}', '{{ $user->first_name }} {{ $user->middle_name }} {{ $user->last_name }}')" class="text-red-500">
                                        ...
                                        <li>
                                            <a href="#" onclick="openModal('{{ route('deleteUser', $user->id) }}', '{{ $user->first_name }} {{ $user->middle_name }} {{ $user->last_name }}')" class="text-red-500">
                                                Trash
                                            </a>
                                        </li>
                ...
                <div class="detail-footer">
                    <div class="pagination-info">
                        Showing {{ $allUser->firstItem() }} to {{ $allUser->lastItem() }} of {{ $allUser->total() }} results
                    </div>
                ...
                <div id="deleteModal" class="delete-modal fixed inset-0 hidden">
                    <div class="delete-mod rounded-md">
                        ...
                        <p>Are you sure you want to delete <span id="userNamePlaceholder"></span>?</p>
                ...
                <div id="suspendModal" class="delete-modal fixed inset-0 hidden">
                    <div class="delete-mod rounded-md">
                        ...
                        <p>Are you sure you want to <span id="suspendActionText">suspend</span> <span id="suspendUserName"></span>?</p>
    ...
    <script>
                    ...
                    var omcChart = new Chart(myCanvas, {
                        ...
                        options: {
                            ...
                            plugins: {
                                ...
                                title: {
                                    display: true,
                                    text: ['Users Registrations', 'This Week vs Last Week'],
                                    align: 'start',
                                    font: {
                                        size: 16,
                                        family: 'Inter',
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (omcAverageChart) {
                ...
                .then(data => {
                    ...
                    omcAverageChart.users = myOMCAverageChart;
                })
                .catch(error => console.error('Error fetching user data:', error));
            }
        });
        ...
        function openModal(actionUrl, userName) {
        ...
        function openSuspendModal(actionUrl, status, userName) {
