...
@section('content')
    ...
    <h2 class="main-title">Dealers for: {{ $omc->omcName }} </h2>

    <div class="back-button">
        <a href="{{ route('viewProfile', $omc->id) }}" 
           class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
           <i class="fa-solid fa-arrow-left"></i> Back to {{ $omc->omcName }} Profile
        </a>
    </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="detail-table w-full">
                ...
                <div class="filt">
                    ...
                    <div>
                        <form method="GET" action="{{ route('viewDealer', $omc->id) }}">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (ctx) {
                ...
                fetch("{{ route('getOMCDealerStats', $omc->id) }}")
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (omcAverageChart) {
                ...
                fetch("{{ route('getOMCDealerAverage', $omc->id) }}")
                .then(response => response.json())
                .then(data => {
