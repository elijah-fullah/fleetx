...
<h2 class="main-title">Update OMC</h2>
...
<div class="form form3 w-full px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
    ...
    <form action="{{ route('updateOMC', $omc->id) }}" method="POST" class="space-y-6">
        ...
        <div class="flex px-4 inp">
            ...
            <div class="w-full px-4 put">
                ...
                <input class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="text" name="omcName" value="{{ old('omcName', $omc->omcName) }}" placeholder="omc Name"/>
                @error('omcName')
            ...
            <div class="w-full px-4 put">
                ...
                <input class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="text" name="licence_no" value="{{ old('licence_no', $omc->licence_no) }}" placeholder="License No"/>
                @error('licence_no')
                <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="flex px-4 inp">
            ...
            <div class="px-4 put">
                ...
                <textarea name="address" cols="30" rows="5" class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker" type="text" name="address" placeholder="Address">{{ old('address', $omc->address) }}</textarea>
                @error('address')
                <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
