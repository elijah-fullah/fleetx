...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (function () {
    ...
    var customersChart1 = document.getElementById('customersChart1');

    if (customersChart1) {
      var customersChartCanvas1 = customersChart1.getContext('2d');
      var myCustomersChart1 = new Chart(customersChartCanvas1, {
        type: 'line',
        data: {
          labels: ['Dec', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
          datasets: [{
      ...
      customersChart1.customers = myCustomersChart1;
    }
  })();
